...
summary <- data %>%
  ...
  summarize(n = n(),  # Sample size
            Mean_temp = mean(monthlyMean_temp), sd_temp = sd(monthlyMean_temp), se_temp = sd_temp/sqrt(n), # Temp
            Mean_soil = mean(monthlyMean_soil), sd_soil = sd(monthlyMean_soil), se_soil = sd_soil/sqrt(n), # Soil moisture
            Mean_height = mean(monthlyMean_height), sd_height = sd(monthlyMean_height), se_height = sd_height/sqrt(n)) # Canopy height
